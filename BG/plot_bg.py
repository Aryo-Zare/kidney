...
new_titles = [ 'pH' , 'pCO2' , 'pO2' , 'Na+' , 'K+' , 'Ca2+' , 'Cl-' ]
...
plt.suptitle( 'Blood gass measurements across time \n after outlier removal'   # Change from baseline of
...
plt.savefig( r'U:\kidney\BG\plot\1\bg_strip_or_bc.pdf' )
